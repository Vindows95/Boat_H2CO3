...
import org.koishi.aof.mcinabox.gamecontroller.definitions.map.MouseMap;
...
public class XKeyMap implements KeyMap, CoKeyMap {
    ...
    private void init() {
        ...
        /* Mouse buttons codes */
        xKeyMap.put(MouseMap.MOUSEMAP_BUTTON_LEFT, GLFW_MOUSE_BUTTON_LEFT);
        xKeyMap.put(MouseMap.MOUSEMAP_BUTTON_RIGHT, GLFW_MOUSE_BUTTON_RIGHT);
        xKeyMap.put(MouseMap.MOUSEMAP_BUTTON_MIDDLE, GLFW_MOUSE_BUTTON_MIDDLE);
        xKeyMap.put(MouseMap.MOUSEMAP_WHEEL_UP, GLFW_MOUSE_BUTTON_LAST);
        xKeyMap.put(MouseMap.MOUSEMAP_WHEEL_DOWN, GLFW_MOUSE_BUTTON_LAST);
    }
