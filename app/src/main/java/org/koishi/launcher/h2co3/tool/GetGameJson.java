...
public class GetGameJson {
    ...
    public static final String boatCfg = "/storage/emulated/0/games/com.koishi.launcher/h2o2/config.txt";
    public static final String h2oCfg = "/storage/emulated/0/games/com.koishi.launcher/h2o2/h2ocfg.json";
    ...
    public static void setAppJson(String name, String value) {
        try {
            ...
            json.remove(name);
            json.put(name, value);
            FileWriter fr = new FileWriter(h2oCfg);
            fr.write(json.toString());
            fr.close();
        } catch (Exception e) {
            System.out.println(e);
