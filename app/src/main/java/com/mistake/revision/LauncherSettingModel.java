...
public class LauncherSettingModel {
    ...
    public void setMinecraftParameter(MinecraftParameter MinecraftParameter) {
    ...
    public static class MinecraftParameter {
        ...
        public void setextraMinecraftFlags(String extraMinecraftFlags) {
            this.extraMinecraftFlags = extraMinecraftFlags;
        }

        public String getauth_player_name() {
            return auth_player_name;
        }

        public void setauth_player_name(String auth_player_name) {
        ...
        public String getgame_assets() {
            return game_assets;
        }

        public void setgame_assets(String game_assets) {
        ...
        public void getuser_type(String user_type) {
            this.user_type = user_type;
        }

        public String getgame_directory() {
            return game_directory;
        }

        public void setgame_directory(String game_directory) {
        ...
        public void setuser_properties(String user_properties) {
            this.user_properties = user_properties;
        }

        public String getassets_root() {
            return assets_root;
        }

        public void setassets_root(String assets_root) {
